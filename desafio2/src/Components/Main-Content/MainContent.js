...
export default function MainContent() {
  ...
  const [checkAction, setcheckAction] = useState(false); //true
  ...
  function onClickBanner() {
    setInputValue("HTMLNAOELINGUAGEM");
  }
    ...
    <div className="main-content-conteiner">
      <div className="main-content-column">
        ...
        <ul className="main-content-genres-list">
          ...
          <label
            for="allmovies"
            class="main-content-genre-title"
            onClick={() => {
              setcheck(!check);
            }}
          >
        ...
        <CardMovieListAll gender={getGender()} x={5} />
      </div>
      <div className="aside-column">
        <Shoplist inputValue={inputValue} />
      </div>
    </div>
  );
}
